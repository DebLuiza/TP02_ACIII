...
module tb_RISCVCPU;
    ...
    task load_program_full_dependencies;
        ...
        //cuidado com as posições da memória ao descomentar os nops
        
        /*
            Comentando os nops para o teste da parte 3
        ...
        */
            ...
            cpu.IMemory[4] = 32'h00a18213; // addi x4, x3, 10     # x4 = x3 + 10 (Já passou tempo para x3)
        ...
        */
            ...
            cpu.IMemory[5] = 32'h00420663; // beq  x4, x4, label  # Salto
            ...
            cpu.IMemory[9] = 32'h0000000b; // halt                # Fim
        end
    endtask
